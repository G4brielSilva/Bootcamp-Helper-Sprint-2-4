...
class PersonFactory {
    static createPersonList() {
        return lista.map((person) => new Person(person.id, person.name, person.bio, person.adasCreator));
    }
}
const newList = PersonFactory.createPersonList();
